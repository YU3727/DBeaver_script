...
--CREATE TABLE NOTICE(
--	NOTICENUM NUMBER, 				-> NUM
--	NOTICETITLE VARCHAR2(400), 		-> TITLE
--	NOTICEDETAIL CLOB,				-> CONTENTS
--	NOTICEWRITER VARCHAR2(400),		-> WRITER
--	NOTICEDATE DATE,				-> REGDATE
--	NOTICEHITS NUMBER				-> HIT
--)
