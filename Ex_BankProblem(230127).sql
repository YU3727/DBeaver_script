...
INSERT INTO PRODUCT 
VALUES(1, 1, 'PRO1', 5.0, '1번상품 3년만기 이자율 5%');
INSERT INTO PRODUCT 
VALUES(2, 1, 'PRO2', 4.5, '2번상품 2년만기 이자율 4.5%');
INSERT INTO PRODUCT 
VALUES(3, 2, 'PRO3', 3.0, '3번상품 1.5년만기 이자율 3%');
INSERT INTO PRODUCT 
VALUES(4, 2, 'PRO4', 2.0, '4번상품 1년만기 이자율 2%');
SELECT * FROM PRODUCT;
...
TRUNCATE TABLE BANKBOOK;

--DEAL에 TABLE 넣기, 잔액계산을 어떻게 해야할까
INSERT INTO DEAL
VALUES (sysdate, '1234567', 50000, 50000);
INSERT INTO DEAL
VALUES (sysdate, '1234567', -30000, 20000);
INSERT INTO DEAL
VALUES (sysdate, '1234567', 100000, 120000);
TRUNCATE TABLE DEAL;
