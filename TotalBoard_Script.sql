...
SELECT R.ROLENAME, M.* FROM MEMBER M
	INNER JOIN
	MEMBER_ROLE MR
	ON(M.ID = MR.ID)
	INNER JOIN 
...
TRUNCATE TABLE ROLE;
INSERT INTO ROLE
VALUES(ROLE_SEQ.NEXTVAL, 'ADMIN');

INSERT INTO ROLE
VALUES(ROLE_SEQ.NEXTVAL, 'MANAGER');
...
INSERT INTO "MEMBER" 
VALUES('user01', 'user01', 'iu', 01000001111, 'iu@gmail.com');

INSERT INTO "MEMBER" 
VALUES('user02', 'user02', 'winter', 01000002222, 'winter@gmail.com');

INSERT INTO "MEMBER" 
VALUES('user03', 'user03', 'suzi', 01000003333, 'suzi@gmail.com');
...
--230303 BankBookCommentAdd
SELECT * FROM BANKBOOKCOMMENT;
SELECT * FROM USER_SEQUENCES;

INSERT INTO BANKBOOKCOMMENT 
VALUES(BANKBOOKCOMMENT_SEQ.NEXTVAL, 385, 'TEST1', sysdate, 'IU');


--230306 BANKBOOKCOMMENT DELETE/UPDATE
SELECT * FROM BANKBOOKCOMMENT ORDER BY NUM DESC;
DELETE BANKBOOKCOMMENT WHERE NUM=1;
UPDATE BANKBOOKCOMMENT SET CONTENTS='수정자료1' WHERE NUM=61;
