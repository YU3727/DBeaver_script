--Notice, QNA까지 합치고, 나중에 db 코드 정리하기. 어차피 월요일날 시험친다
SELECT * FROM TAB;
...
ALTER TABLE BANKBOOKCOMMENT ADD CONSTRAINT BBCOMMENT_PNUM_PK PRIMARY KEY (NUM);
ALTER TABLE BANKBOOKCOMMENT ADD CONSTRAINT BBCOMMENT_FNUM_FK FOREIGN KEY (BOOKNUMBER) REFERENCES BANKBOOK (BOOKNUMBER);
